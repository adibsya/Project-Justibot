...
>>>>>>> 9fe667ca45431274efc8781c70d90e8699ed6818
  return (
    <header className="fixed top-0 left-0 w-full z-50 shadow-md font-medium transition-colors duration-300 bg-secondary">
      <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="text-onPrimary font-bold flex items-center space-x-2">
...
<<<<<<< HEAD
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden fixed inset-x-0 top-[64px] bg-background p-5 rounded-lg text-center z-50">
            <ul className="space-y-4">
              <NavigationItems handleProtectedRoute={handleProtectedRoute} isMobile toggleMenu={toggleMenu} />
              {isLoggedIn ? (
                <li>
                  <button
                    onClick={() => {
              ...
              <div className="relative">
                ...
                {showProfileDropdown && (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center space-y-4 mb-6">
                      <div
                        className="w-20 h-20 rounded-full border border-white-300
