...
const LawyerPromo = () => {
  return (
    <div className="bg-surface">
      <section className="relative py-14 px-4 sm:px-8 md:px-16 mx-2 sm:mx-8 md:mx-20 rounded-2xl shadow-xl border border-gray-100 transition-all duration-300 overflow-hidden bg-gradient-to-br from-secondary/10 via-white to-primary/10">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start">
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-2 text-gray-800 text-center md:text-left">
              ...
              <span className="text-secondary drop-shadow-md">
                Gabung & Raih Lebih Banyak Klien!
              </span>
            </h2>
            ...
            <p className="mb-6 max-w-xl text-center md:text-left text-gray-600 text-base sm:text-lg">
              Jadilah bagian dari komunitas pengacara profesional kami dan
              perluas jaringan Anda secara digital.
              <br />
              <span className="font-medium text-secondary">
                Sudah punya kantor terdaftar?
              </span>{" "}
              Daftar sebagai pengacara sekarang juga.
              <br />
              <span className="font-medium text-secondary">
                Belum punya kantor?
              </span>{" "}
              Daftarkan kantor Anda dan mulai membangun reputasi online!
            </p>
