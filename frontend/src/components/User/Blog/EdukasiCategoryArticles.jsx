...
const EdukasiCategoryArticles = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const response = await axios.get("/api/articles?category=Edukasi");
  ...
  return (
    <div className="text-onSurface">
      <div className="w-full max-w-7xl mx-auto px-4 mt-8">
        ...
        >
          Dapatkan pengetahuan baru dengan artikel yang penuh dengan
          tips, tutorial, dan informasi yang mudah dipahami untuk memperkaya
          wawasan Anda.
        </motion.p>
        ...
        <div className="flex justify-end mt-4 mr-4">
          <Link to="/artikel/artikel-edukasi" className="flex items-center">
...
export default EdukasiCategoryArticles;
