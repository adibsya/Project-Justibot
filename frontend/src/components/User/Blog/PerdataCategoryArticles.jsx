...
const PerdataCategoryArticles = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const response = await axios.get("/api/articles?category=Hukum Perdata");
  ...
  return (
    <div className="text-onSurface">
      <div className="w-full max-w-7xl mx-auto px-4 mt-8">
        ...
        >
          Temukan sudut pandang baru dalam setiap artikel opini kami, mengajak
          Anda berpikir kritis tentang isu-isu terkini dan perspektif yang
          menarik.
        </motion.p>
        ...
        <div className="flex justify-end mt-4 mr-4">
          <Link to="/artikel/artikel-perdata" className="flex items-center">
            <span className="text-md font-medium hover:underline self-start">
              Semua Artikel Perdata
            </span>
...
export default PerdataCategoryArticles;
