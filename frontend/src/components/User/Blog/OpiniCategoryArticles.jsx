...
const OpiniCategoryArticles = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const response = await axios.get("/api/articles?category=Opini");
    ...
    <div className="text-onSurface">
      <div className="w-full max-w-7xl mx-auto px-4 mt-8">
        ...
        <div className="flex justify-end mt-4 mr-4">
          <Link to="/artikel/artikel-opini" className="flex items-center">
...
export default OpiniCategoryArticles;
