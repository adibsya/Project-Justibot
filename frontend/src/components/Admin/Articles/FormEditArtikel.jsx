...
const FormEditArtikel = () => {
  ...
  // Simulasi ambil data berdasarkan ID (sementara dummy)
  useEffect(() => {
    const dummyData = {
      1: {
        title: "Efisiensi yang dilakukan untuk kesejahteraan rakyat berujung korupsi?",
    ...
    const artikel = dummyData[id];
    if (artikel) {
      setJudul(artikel.title);
      setIsi(artikel.content);
    }
  }, [id]);
