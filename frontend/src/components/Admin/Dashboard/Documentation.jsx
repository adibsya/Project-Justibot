...
const sections = [
  ...
  },
  {
    icon: "👨‍⚖️",
    title: "Kelola Lawyer",
    description: `Buka menu Lawyers. Tambahkan data lawyer baru dengan tombol "Tambah". Gunakan fitur edit atau hapus untuk manajemen data.`,
  },
  {
    icon: "📊",
    title: "Analisis Chatbot",
    description: `Di menu Chatbot Analysis, Anda dapat melihat data percakapan antara pengguna dan chatbot untuk memahami tren pertanyaan.`,
  },
  {
    icon: "🚪",
    title: "Logout",
