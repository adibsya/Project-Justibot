  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
      <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
        <div>
          <h2 className="text-2xl font-bold text-[#122E40] mb-1">Trend of User Sessions</h2>
        </div>
      ...
      <ResponsiveContainer width="100%" height={320}>
        <LineChart data={getData()} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
          ...
          <Tooltip
            contentStyle={{ backgroundColor: '#fff', border: '1px solid #E5DED5', borderRadius: 10 }}
